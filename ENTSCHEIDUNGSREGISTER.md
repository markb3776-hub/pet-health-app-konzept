...
| E-102 | ~~Gruppen-Icons statt Großbuchstaben~~ → ENTFÄLLT | **ENTFÄLLT** – durch Variante C (Gruppen-Accordion) ist die Tierart bereits über den Gruppen-Header erkennbar. Großbuchstaben bleiben als Default-Avatar bestehen. | Nutzer-Entscheidung 25.07.2026: "Dann können auch die Anfangsbuchstaben so bleiben wie es aktuell ist, da es ja schon gruppiert ist." Gruppen-Icons wären redundant. |
