...
| E-102 | Gruppen-Icons statt Großbuchstaben (Default-Avatar) | Wenn einem Tier kein eigenes Foto zugewiesen ist, wird statt des Großbuchstabens ein gruppen-spezifisches Tier-Icon angezeigt: Hund → Hunde-Silhouette, Katze → Katzen-Silhouette, Reptil/Terrarium → Salamander/Eidechse, Fisch/Aquarium → Fisch, Pferd → Pferde-Silhouette, Vogel → Vogel-Silhouette, Kaninchen/Nager → Kaninchen-Silhouette. Icons als SVG oder Emoji-basiert, monochrom in der jeweiligen Gruppenfarbe. | Tester-Feedback 25.07.2026: "Aus dem Großbuchstaben machen wir passende Icons für die jeweilige Gruppe...Fisch für Aquarium, Salamander für Terrarium etc." Der Buchstabe sagt nichts über die Tierart aus – das Icon sofort. |
| E-103 | HomeScreen-Layout bei vielen Tieren (Entscheidung offen) | 3 Mockups erstellt zur Auswahl: (A) 2-Spalten-Grid – kompakte Kacheln, 6 Tiere auf einen Blick. (B) Horizontales Karussell – Tier-Avatare als Swipe-Leiste, darunter Termine. (C) Gruppen-Accordion – einklappbare Gruppen-Header (Hunde, Katzen, Aquarium). Alle 3 Varianten mit Gruppen-Farben und Gruppen-Icons. Entscheidung steht noch aus. | Tester-Feedback 25.07.2026: "Wenn hier noch 2 Tiere hinzugefügt werden, wird's unübersichtlich. Hier muss ne saubere Lösung gefunden werden." Bei 5 Tieren ist der Screen bereits voll, bei 7+ muss gescrollt werden. |
