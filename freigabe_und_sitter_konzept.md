...
**Tierart-übergreifende Ergänzung (09.07.2026):** Für Käfig-, Terrarien- und Beckentiere ist neben der Fütterung die **Haltungstechnik** überlebenswichtig. Der Sitter-Zettel erhält deshalb einen optionalen Abschnitt **"Haltung & Technik"**: Lampen-Zeiten und Zieltemperaturen beim Reptil, Technik-Check und Ausfall-Anweisung beim Aquarium, Freiflug-Regeln und Dämpfe-Warnung beim Ziervogel, Gehäuse-Sicherung und Temperaturgrenzen bei Kleinsäugern (Hitzschlag-Risiko ab ~26 °C), Weide-/Boxenregime und Hufschmied-Kontakt beim Pferd. Details: tierarten_abdeckung_festlegungen.md, Abschnitt 4.
